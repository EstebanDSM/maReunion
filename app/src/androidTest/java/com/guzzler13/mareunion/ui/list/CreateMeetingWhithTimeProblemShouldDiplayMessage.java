...
public class CreateMeetingWhithTimeProblemShouldDiplayMessage {
    ...
    @Test
    public void createMeetingWhithTimeProblemShouldDiplayMessage() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.meetingName_editText), withText("test"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.meetingName_TextInputLayout),
                                        0),
        ...
        ViewInteraction appCompatAutoCompleteTextView = onView(
                allOf(withId(R.id.participant_autoCompleteTextView),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatAutoCompleteTextView.perform(replaceText("ab@cd.com"), closeSoftKeyboard());
        ...
        onView(withText("Veuillez vérifier les heures de début et de fin")).inRoot(withDecorView(not(is(mActivityTestRule.
