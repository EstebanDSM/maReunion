...
public class CreateMeetingWhithoutTimeBeginShouldDiplayMessage {

    @Rule
    public ActivityTestRule<MeetingListActivity> mActivityTestRule = new ActivityTestRule<>(MeetingListActivity.class);

    @Test
    public void createMeetingWhithoutTimeBeginShouldDiplayMessage() {
        ...
        onView(withText("Veuillez SVP définir l'heure de début")).inRoot(withDecorView(not(is(mActivityTestRule.
