...
public class CreateMeetingWhithoutMeetingRoomShouldDiplayMessage {
    ...
    @Test
    public void createMeetingWhithoutMeetingRoom() {
        ...
        onView(withText("Veuillez SVP choisir une salle")).inRoot(withDecorView(not(is(mActivityTestRule.
